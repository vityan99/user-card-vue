# Карточка с возможностью загрузки данных при клике на кнопку (Vue + TS)

Карточка с возможностью загрузки данных при клике на кнопку

## Preview

![Wheels preview](https://github.com/vityan99/user-card-vue/blob/main/preview-1.png)
![Wheels preview](https://github.com/vityan99/user-card-vue/blob/main/preview-2.png)
